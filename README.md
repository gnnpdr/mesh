...
***Распределение вершина на ячейки***. просто просматриваем все вершины, по ним определяем ячейку, в которую они попали, а потом дополняем инфу по этой ячейке - обновляем сумму в CellData

***Нахождение оптимального положения новой вершины***. Очевидно, брать центр ячеки - не вариант. Возьмем среднее по всем вершинам. Информация для этого уже содержится у нас в CellData.

***Триангулируем снова*** в процессе работы создаем таблицы, с помощью которых можно сопоставить старое и новое, так что по старым треугольникам ссылаемяс на новые вершины и оставляем только невырожденные треугольники и пушим в новый меш.
